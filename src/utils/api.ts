...
export const sendMessageToDeana = async (text: string): Promise<Message[]> => {
  ...
  const responses = [
    ...
    "That's an interesting question about: " + text + ". Here's what I think...",
    "Based on your message about: " + text + ", I'd recommend the following approach...",
    "Great question! Regarding: " + text + ", here are some key points to consider...",
  ];
...
// Placeholder for n8n webhook calls
export const callN8nWebhook = async (webhookUrl: string, data: any) => {
  console.log('Calling n8n webhook:', webhookUrl, data);
